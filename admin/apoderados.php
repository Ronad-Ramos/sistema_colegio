...
<head>
  <meta charset="utf-8"> 
    ...
    <title> Apoderados | Virgen De Guadalupe </title>
...
<div class="wrapper">
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Apoderados</h4>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item active" aria-current="page">Administrar Apoderados</li>
							</ol>
						</nav>
					</div>
				</div>
  ...
  <!-- /.content-wrapper -->
	...
	<script type="text/javascript" src="funciones/apoderados.js"></script>
	<!-- Vendor JS -->

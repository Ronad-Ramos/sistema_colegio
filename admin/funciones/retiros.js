...
function registrarRetiro(){
    ...
    if($('#dtoNeutral').val() == 1 ){ var urld = "controles/code=retiros.php";}else{ var urld = "admin/controles/code=retiros.php";}
...
function eliminarRetiro(e){
    ...
    $.ajax({
        data:  parametros,
        url:   'controles/code=retiros.php',
        type:  'post',
        beforeSend: function () {
